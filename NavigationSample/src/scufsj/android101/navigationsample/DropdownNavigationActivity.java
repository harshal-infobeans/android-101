...
public class DropdownNavigationActivity extends FragmentActivity implements ActionBar.OnNavigationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dropdown_navigation);
